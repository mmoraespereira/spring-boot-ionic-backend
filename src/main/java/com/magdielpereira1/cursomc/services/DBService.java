...
import com.magdielpereira1.cursomc.domain.Pagamento;
import com.magdielpereira1.cursomc.domain.PagamentoComBoleto;
import com.magdielpereira1.cursomc.domain.PagamentoComCartao;
...
import com.magdielpereira1.cursomc.repositories.CidadeRepository;
...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		Cidade c1 = new Cidade(null, "Humberlândia", est1);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "mpereira950@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "magdielpereira1@hotmail.com", "83616987016", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("95564654", "787845212"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106",null, "Centro", "83020460", cli2, c2);
		...
		Pagamento pagot2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("20/10/2017 00:00"),
				null);
		ped2.setPagamento(pagot2);

		cli1.getPedidos().addAll(Arrays.asList(ped1, ped2));

		pedidoRepository.saveAll(Arrays.asList(ped1, ped2));
		pagamentoRepository.saveAll(Arrays.asList(pagto1, pagot2));
